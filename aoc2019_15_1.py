...
def repairDroneFindOxegynTank(seedFunction):
	...
	while opcodeTuple[1] != 99:
		...
		if opcodeTuple[0] == 0:
			...
			print("DEBUG: repairDroneFindOxegynTank: found wall at {}, last direction was {} and current direction is {}".format(attemptedDroidLocation, lastDir, cycleDir(lastDir)))
